...
class CameraCalibration(QWidget):
    ...
    def __init__(self, process_controls,  parent=None):
        ...
        # # CLEAN THIS
        # self.plot_tabs.setFixedWidth(640)
        # self.plot_tabs.setFixedHeight(480)
