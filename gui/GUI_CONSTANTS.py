...
PREPROCESSING_CONSTANTS_CENTROID_TOLERANCE = 'Centroid tolerance:'
PREPROCESSING_CONSTANTS_CENTROID_TOLERANCE_SUFFIX = '  px'
...
PREPROCESSING_DISPLAY_CENTROID_TOL = 'Centroid tolerance'
PREPROCESSING_DISPLAY_CENTROID_TOL_VALUE = '{} px'
...
INFORMATION_POLYNOMIAL_SP_MM_VALUE = 'SP converted:'
INFORMATION_POLYNOMIAL_SP_MM_VALUE_FIELD = '{:.2f} mm'
INFORMATION_POLYNOMIAL_CONV_FACTOR = 'Conversion factor:'

# Main Window
MAIN_WINDOW_TITLE = 'SPD: Smoke Point Detection'