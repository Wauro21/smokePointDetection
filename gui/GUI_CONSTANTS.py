...
PREPROCESSING_CAMERA_CALIBRATION_CONTROLS_THRESHOLD = 'Threshold percentage:'
PREPROCESSING_CAMERA_CALIBRATION_CONTROLS_THRESHOLD_MAX = 100
PREPROCESSING_CAMERA_CALIBRATION_CONTROLS_SQUARE_SIDE = 'Square side:'
PREPROCESSING_CAMERA_CALIBRATION_CONTROLS_SQUARE_FIELD = '{} px'
PREPROCESSING_CAMERA_CALIBRATION_CONTROLS_PX_AVG = 'AVG:'
PREPROCESSING_CAMERA_CALIBRATION_CONTROLS_PX_AVG_FIELD = '{} px'
PREPROCESSING_CAMERA_CALIBRATION_CONTROLS_PX_STD = 'STD:'
PREPROCESSING_CAMERA_CALIBRATION_CONTROLS_PX_STD_FIELD = '{} px'
PREPROCESSING_CAMERA_CALIBRATION_PX_MM_TITLE = 'Convertion factor:'
...
PREPROCESSING_CAMERA_CALIBRATION_PX_MM_DEF_THRESH = 29
