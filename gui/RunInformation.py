...
class FrameInformation(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.labels = [self.n_frames, self.n_invalid_frames, self.centroid_reference, self.n_points_h, self.n_points_H, self.processing_time]
