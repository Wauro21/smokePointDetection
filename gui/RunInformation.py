...
class InformationTab(QWidget):
    ...
    def demo(self):
        ...
        self.demo_counter += 1
        val = 100*(self.demo_counter/self.process_controls['n_frames'])
